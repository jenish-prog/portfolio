        ...
        <div className="row">
          <div className="blog-card">
            ...
            <div className="content-holder">
              ...
              <p className="post-details">
                <a href="#blog">By: Admin</a>
                <a href="#blog"><i className="ti-heart text-danger"></i> 234</a>
                <a href="#blog"><i className="ti-comment"></i> 123</a>
              </p>
              ...
              <a href="#blog" className="read-more">Read more <i className="ti-angle-double-right"></i></a>
            </div>
          ...
          <div className="blog-card">
            ...
            <div className="content-holder">
              ...
              <p className="post-details">
                <a href="#blog">By: Admin</a>
                <a href="#blog"><i className="ti-heart text-danger"></i> 456</a>
                <a href="#blog"><i className="ti-comment"></i> 264</a>
              </p>
          ...
          <div className="blog-card">
            ...
            <div className="content-holder">
              ...
              <p className="post-details">
                <a href="#blog">By: Admin</a>
                <a href="#blog"><i className="ti-heart text-danger"></i> 431</a>
                <a href="#blog"><i className="ti-comment"></i> 312</a>
              </p>
